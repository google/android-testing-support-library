...
import androidx.test.platform.io.PlatformTestStorageRegistry.NoOpPlatformTestStorage;
...
public class PlatformTestStorageRegistryTest {
  ...
  @Test
  public void getInstance_defaultInstance() {
    assertThat(PlatformTestStorageRegistry.getInstance()).isEqualTo(new NoOpPlatformTestStorage());
  }
}
